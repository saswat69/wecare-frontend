      ...
      <div className="img-background">
        ...
        <div className='container'>
          <div className="row">
            ...
            <form>
            <h4 className='text-center  mb-4'><img src="https://www.freeiconspng.com/thumbs/login-icon/user-login-icon-14.png" className='img-size-2' id="icon" alt="User Icon" />Login As Life Coach</h4>
